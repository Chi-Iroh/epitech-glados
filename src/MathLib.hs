...
mathBuiltins = [    BackendBuiltins ("*", 2, pdpArithmeticOp "*" (*))
            ,       BackendBuiltins ("mul", 2, pdpArithmeticOp "mul" (*))
            ,   BackendBuiltins ("+", 2, pdpArithmeticOp "+" (+))
            ...
            ,   BackendBuiltins ("/", 2, pdpArithmeticOp "div" (/))
            ,   BackendBuiltins ("mod", 2, pdpModulo)
            ,   BackendBuiltins ("%", 2, pdpModulo)
            ,   BackendBuiltins ("**", 2, pdpArithmeticOp "**" (**))
            ,   BackendBuiltins ("pow", 2, pdpArithmeticOp "pow" (**))
            ,   BackendBuiltins ("v-", 1, pdpArithmeticSingleOp "v-" sqrt)
            ,   BackendBuiltins ("sqrt", 1, pdpArithmeticSingleOp "v-" sqrt)
            ,   BackendBuiltins ("!!", 1, pdpFactorial)
