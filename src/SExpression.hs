module SExpression
    ( SExpr(SNumber, SSymbol, SList, STuple, SArray, SFunctionType, SString),
    getSymbol,
    getInteger,
    getList,
    fromSymbol
...
data SExpr = SNumber Int | SSymbol String | SList [SExpr] | STuple [SExpr] | SArray [SExpr] | SFunctionType [SExpr] | SString String deriving (Eq, Show)
