...
- Nils Perriolat - Parsing
- Swan Sallet - Parsing
- Marion Kauffman - CI/CD + Deserialization
- Axel Chypre - Interpreter functional tests + Serialization
- Maksen Mofredj - Standard library + VM
- Thomas Sayen - Interpreter + Compiler